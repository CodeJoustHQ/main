...
public class CreateUserResponse {
	...
	public static final String ERROR_INVALID_NICKNAME = "The provided nickname is invalid, for one of four reasons: it is empty, longer than sixteen characters, or contains a space.";
